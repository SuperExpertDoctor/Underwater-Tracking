...
- **未来事件推演**:基于 IMM、B 样条、UUV 状态与可观测性反馈，按 H1～H4
  展示转向、高速脱离、覆盖缺口和丢失风险等事件；规则模块只读且无控制权，
  详见 [`docs/rule-world-model-integration.md`](docs/rule-world-model-integration.md)
