...
const sceneAssets = [
  ...
  { name: "aircraft-carrier", path: "/assets/aircraft-carrier.png" },
  { name: "warship", path: "/assets/warship.png" },
  { name: "uuv", path: "/assets/UUV.png" },
  { name: "submarine", path: "/assets/submarine.png" },
] as const;
