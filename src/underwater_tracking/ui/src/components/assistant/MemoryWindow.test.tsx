...
const populatedSnapshot: MemorySnapshotView = {
  ...
  semantic: [{ memory_id: "semantic-1", memory_family_id: "family-s", version: 2, user_id: "operator", scenario_id: "scenario-1", memory_type: "semantic", summary: "语义结论", importance_score: 0.9, status: "active", source_decision_ids: ["decision-1"], access_count: 5 }],
  ...
  retrieved_hits: [{ memory: { memory_id: "semantic-1", memory_family_id: "family-s", version: 2, user_id: "operator", scenario_id: "scenario-1", memory_type: "semantic", summary: "语义结论", importance_score: 0.9, status: "active", source_decision_ids: ["decision-1"], access_count: 5 }, similarity_score: 0.88, rerank_score: 0.91, retrieval_reason: "与当前问题相关" }],
  versions: [],
