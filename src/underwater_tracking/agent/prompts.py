...
STRATEGY_SYSTEM_PROMPT = (
    ...
    "the active plan version, and hard-guard reasons. "
    ...
    "intelligence, passive sensing range, bearing precision, speed, turn "
    "capability, and available energy before choosing priorities or "
