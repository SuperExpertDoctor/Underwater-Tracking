...
- Status: **BLOCKED/FAIL**
- Git commit: `b3ec6fc99aaea74b85415e10c5f94ea65b969ec1`
- Config SHA-256: `0ea7495cff65ff4f1ef44fb9ae8110d467a5027badb6ea932418637bba95cf31`
- Wall-clock start (UTC): `2026-08-24T20:13:48.627709+00:00`
- Wall-clock end (UTC): `2026-08-24T20:29:02.478453+00:00`
- First plan latency: `59.02956154104322` s
- Final run phase: `completed`
- Final simulation time: `28800` s
- Final plan version: `17`
- Motion audits: `17`
...
| `carrier_returned` | `6870` | `6` |
| `initial_plan_committed` | `0` | `1` |
| `passive_track` | `90` | `1` |
| `recovery` | `1925` | `2` |
| `resource_threshold` | `2220` | `2` |
| `uuv_deployed` | `90` | `1` |
| `uuv_recovered` | `2530` | `2` |
...
| `carrier_03` | `5760` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25000000000000006/0.25` | `n/a` | `0/0/0/0/0/0/0` |
...
- incomplete_blue_tracking_candidates:target_00:cell:-1:-1,target_00:cell:-2:-4,target_00:cell:-3:-4
