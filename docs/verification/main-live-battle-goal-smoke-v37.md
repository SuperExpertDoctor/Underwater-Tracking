...
- Wall-clock start (UTC): `2026-08-24T08:00:27.493856+00:00`
- Wall-clock end (UTC): `2026-08-24T08:05:14.811749+00:00`
- First plan latency: `80.11390804499388` s
- Final run phase: `running`
- Final simulation time: `7200` s
- Final plan version: `4`
- Motion audits: `17`
- Physics frames observed/expected: `1514/1441`
- Browser errors: `1`
- Failed requests: `2`
- Memory events: `38`
- API p95: `144.765` ms
- Output bytes: `56085267`
- Shutdown: `7.013` s
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `carrier_01` | `1513` | `4.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_02` | `1513` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_03` | `1513` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_04` | `1513` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `target_00` | `1513` | `8.400000000000002/14.0` | `0.0799999999999983/0.08` | `3.552713678800501e-16/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_00` | `1513` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982992/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_01` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_02` | `1513` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_03` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_04` | `1513` | `4.0/4.0` | `0.1/0.1` | `0.0/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_05` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_06` | `1513` | `4.0/4.0` | `0.1/0.1` | `0.0/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_07` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_08` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_09` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_10` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_11` | `1513` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
...
- physics_frame_count_mismatch:1514!=1441
- physics_step_count_mismatch:carrier_01:1513!=1440
- physics_step_count_mismatch:carrier_02:1513!=1440
- physics_step_count_mismatch:carrier_03:1513!=1440
- physics_step_count_mismatch:carrier_04:1513!=1440
- physics_step_count_mismatch:target_00:1513!=1440
- physics_step_count_mismatch:uuv_00:1513!=1440
- physics_step_count_mismatch:uuv_01:1513!=1440
- physics_step_count_mismatch:uuv_02:1513!=1440
- physics_step_count_mismatch:uuv_03:1513!=1440
- physics_step_count_mismatch:uuv_04:1513!=1440
- physics_step_count_mismatch:uuv_05:1513!=1440
- physics_step_count_mismatch:uuv_06:1513!=1440
- physics_step_count_mismatch:uuv_07:1513!=1440
- physics_step_count_mismatch:uuv_08:1513!=1440
- physics_step_count_mismatch:uuv_09:1513!=1440
- physics_step_count_mismatch:uuv_10:1513!=1440
- physics_step_count_mismatch:uuv_11:1513!=1440
