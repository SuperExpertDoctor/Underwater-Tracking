...
- Wall-clock start (UTC): `2026-08-24T00:05:44.900909+00:00`
- Wall-clock end (UTC): `2026-08-24T00:08:28.180635+00:00`
- First plan latency: `64.68136272905394` s
- Final run phase: `running`
- Final simulation time: `1800` s
- Final plan version: `3`
- Motion audits: `17`
- Physics frames observed/expected: `365/361`
- Browser errors: `2`
- Failed requests: `0`
- Memory events: `24`
- API p95: `126.357` ms
- Output bytes: `20687562`
- Shutdown: `2.518` s
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `carrier_01` | `364` | `4.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.0/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_02` | `364` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_03` | `364` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_04` | `364` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.0/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `target_00` | `364` | `8.400000000000002/14.0` | `0.0799999999999983/0.08` | `3.552713678800501e-16/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_00` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_01` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982988/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_02` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_03` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982988/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_04` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982992/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_05` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_06` | `364` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982988/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_07` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_08` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_09` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_10` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_11` | `364` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
...
- physics_frame_count_mismatch:365!=361
- physics_step_count_mismatch:carrier_01:364!=360
- physics_step_count_mismatch:carrier_02:364!=360
- physics_step_count_mismatch:carrier_03:364!=360
- physics_step_count_mismatch:carrier_04:364!=360
- physics_step_count_mismatch:target_00:364!=360
- physics_step_count_mismatch:uuv_00:364!=360
- physics_step_count_mismatch:uuv_01:364!=360
- physics_step_count_mismatch:uuv_02:364!=360
- physics_step_count_mismatch:uuv_03:364!=360
- physics_step_count_mismatch:uuv_04:364!=360
- physics_step_count_mismatch:uuv_05:364!=360
- physics_step_count_mismatch:uuv_06:364!=360
- physics_step_count_mismatch:uuv_07:364!=360
- physics_step_count_mismatch:uuv_08:364!=360
- physics_step_count_mismatch:uuv_09:364!=360
- physics_step_count_mismatch:uuv_10:364!=360
- physics_step_count_mismatch:uuv_11:364!=360
