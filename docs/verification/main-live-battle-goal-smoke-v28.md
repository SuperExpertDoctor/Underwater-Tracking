...
- Wall-clock start (UTC): `2026-08-24T02:55:11.094685+00:00`
- Wall-clock end (UTC): `2026-08-24T02:58:01.678477+00:00`
- First plan latency: `61.058224068023264` s
- Final run phase: `running`
- Final simulation time: `2420` s
- Final plan version: `5`
- Motion audits: `17`
- Physics frames observed/expected: `498/481`
- Browser errors: `0`
- Failed requests: `2`
- Memory events: `35`
- API p95: `157.174` ms
- Output bytes: `27738620`
- Shutdown: `2.835` s
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `carrier_01` | `497` | `4.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.0/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_02` | `497` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_03` | `497` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_04` | `497` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `target_00` | `497` | `8.400000000000002/14.0` | `0.0799999999999983/0.08` | `7.105427357601002e-16/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_00` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_01` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_02` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_03` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_04` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982992/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_05` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_06` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_07` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_08` | `497` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982992/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_09` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_10` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_11` | `497` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
...
- physics_frame_count_mismatch:498!=481
- physics_step_count_mismatch:carrier_01:497!=480
- physics_step_count_mismatch:carrier_02:497!=480
- physics_step_count_mismatch:carrier_03:497!=480
- physics_step_count_mismatch:carrier_04:497!=480
- physics_step_count_mismatch:target_00:497!=480
- physics_step_count_mismatch:uuv_00:497!=480
- physics_step_count_mismatch:uuv_01:497!=480
- physics_step_count_mismatch:uuv_02:497!=480
- physics_step_count_mismatch:uuv_03:497!=480
- physics_step_count_mismatch:uuv_04:497!=480
- physics_step_count_mismatch:uuv_05:497!=480
- physics_step_count_mismatch:uuv_06:497!=480
- physics_step_count_mismatch:uuv_07:497!=480
- physics_step_count_mismatch:uuv_08:497!=480
- physics_step_count_mismatch:uuv_09:497!=480
- physics_step_count_mismatch:uuv_10:497!=480
- physics_step_count_mismatch:uuv_11:497!=480
