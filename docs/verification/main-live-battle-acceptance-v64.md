...
- Status: **BLOCKED/FAIL**
- Git commit: `edab8fba0557557b5b53bce1b3e03d8834ee6bf1`
- Config SHA-256: `0ea7495cff65ff4f1ef44fb9ae8110d467a5027badb6ea932418637bba95cf31`
- Wall-clock start (UTC): `2026-08-24T20:51:43.012705+00:00`
- Wall-clock end (UTC): `2026-08-24T21:19:33.950149+00:00`
- First plan latency: `95.19739533006214` s
- Final run phase: `completed`
- Final simulation time: `28800` s
- Final plan version: `70`
- Motion audits: `17`
...
| `carrier_returned` | `6050` | `9` |
| `initial_plan_committed` | `0` | `1` |
| `passive_track` | `90` | `1` |
| `recovery` | `2460` | `2` |
| `resource_threshold` | `2190` | `1` |
| `uuv_deployed` | `90` | `1` |
| `uuv_recovered` | `3045` | `2` |
...
| `carrier_02` | `5760` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25000000000000006/0.25` | `n/a` | `0/0/0/0/0/0/0` |
...
| `target_00` | `5760` | `8.400000000000002/14.0` | `0.08000000000000025/0.08` | `0.1000000000000009/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
