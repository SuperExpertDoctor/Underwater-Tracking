...
- Status: **BLOCKED/FAIL**
- Git commit: `b4824fe28d6df72ce3f9a232b024228873b1d100`
- Config SHA-256: `96c1b9519c66b9ec9c14f64ab85508a402cda8d7ff50a6a7907964e370d1f4db`
- Wall-clock start (UTC): `2026-08-24T15:30:34.600583+00:00`
- Wall-clock end (UTC): `2026-08-24T15:34:46.782621+00:00`
- First plan latency: `91.13654977700207` s
...
| `passive_track` | `90` | `1` |
| `recovery` | `2010` | `1` |
| `resource_threshold` | `1560` | `1` |
| `uuv_deployed` | `90` | `1` |
| `uuv_recovered` | `2765` | `1` |
...
| `target_00` | `900` | `8.400000000000002/14.0` | `0.0799999999999983/0.08` | `3.552713678800501e-16/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
...
| `uuv_06` | `900` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_07` | `900` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982992/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
...
- missing_stages:carrier_returned
