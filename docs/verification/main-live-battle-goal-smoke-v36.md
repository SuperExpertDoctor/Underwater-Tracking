...
- Wall-clock start (UTC): `2026-08-24T07:37:46.193726+00:00`
- Wall-clock end (UTC): `2026-08-24T07:41:51.100313+00:00`
- First plan latency: `75.05893880396616` s
- Final run phase: `running`
- Final simulation time: `7200` s
- Final plan version: `1`
- Motion audits: `17`
- Physics frames observed/expected: `1449/1441`
- Browser errors: `0`
- Failed requests: `0`
- Memory events: `31`
- API p95: `176.607` ms
- Output bytes: `48109025`
- Shutdown: `3.389` s
...
| --- | ---: | ---: | ---: | ---: | ---: | --- | ---: |
| `carrier_01` | `1448` | `4.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_02` | `1448` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_03` | `1448` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `carrier_04` | `1448` | `8.0/8.0` | `0.0/0.25` | `0.0/0.25` | `0.25/0.25` | `n/a` | `0/0/0/0/0/0/0` |
| `target_00` | `1448` | `8.400000000000002/14.0` | `0.0799999999999983/0.08` | `7.105427357601002e-16/0.1` | `0.010471975511966214/0.010471975511965976` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_00` | `1448` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_01` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_02` | `1448` | `4.0/4.0` | `0.1/0.1` | `0.1/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_03` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_04` | `1448` | `4.0/4.0` | `0.1/0.1` | `0.0/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_05` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_06` | `1448` | `4.0/4.0` | `0.1/0.1` | `0.0/0.1` | `0.05235987755982989/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_07` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_08` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_09` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_10` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
| `uuv_11` | `1448` | `0.0/4.0` | `0.0/0.1` | `0.0/0.1` | `0.0/0.05235987755982988` | `n/a` | `0/0/0/0/0/0/0` |
...
- physics_frame_count_mismatch:1449!=1441
- physics_step_count_mismatch:carrier_01:1448!=1440
- physics_step_count_mismatch:carrier_02:1448!=1440
- physics_step_count_mismatch:carrier_03:1448!=1440
- physics_step_count_mismatch:carrier_04:1448!=1440
- physics_step_count_mismatch:target_00:1448!=1440
- physics_step_count_mismatch:uuv_00:1448!=1440
- physics_step_count_mismatch:uuv_01:1448!=1440
- physics_step_count_mismatch:uuv_02:1448!=1440
- physics_step_count_mismatch:uuv_03:1448!=1440
- physics_step_count_mismatch:uuv_04:1448!=1440
- physics_step_count_mismatch:uuv_05:1448!=1440
- physics_step_count_mismatch:uuv_06:1448!=1440
- physics_step_count_mismatch:uuv_07:1448!=1440
- physics_step_count_mismatch:uuv_08:1448!=1440
- physics_step_count_mismatch:uuv_09:1448!=1440
- physics_step_count_mismatch:uuv_10:1448!=1440
- physics_step_count_mismatch:uuv_11:1448!=1440
